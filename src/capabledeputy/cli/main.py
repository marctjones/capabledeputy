...
from capabledeputy.cli.metrics_cmd import metrics_command
...
app.command("mcp-server-outlook")(_make_bundled_mcp_command("outlook"))
app.command("mcp-server-word")(_make_bundled_mcp_command("word"))
app.command("mcp-server-powerpoint")(_make_bundled_mcp_command("powerpoint"))
