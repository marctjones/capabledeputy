...
_CHECK_FOR_KIND: dict[CapabilityKind, callable] = {  # type: ignore[type-arg]
    ...
    CapabilityKind.OUTLOOK_READ: _check_external_read,
    CapabilityKind.OUTLOOK_DRAFT: _check_send_email,
    CapabilityKind.WORD_READ: _check_local_app,
    CapabilityKind.WORD_EDIT: _check_local_app,
    CapabilityKind.WORD_EXPORT: _check_local_app,
    CapabilityKind.POWERPOINT_READ: _check_local_app,
    CapabilityKind.POWERPOINT_EDIT: _check_local_app,
    CapabilityKind.POWERPOINT_EXPORT: _check_local_app,
    CapabilityKind.POWERPOINT_PRESENT: _check_local_app,
    ...
    CapabilityKind.EXTERNAL_MAIL_DRAFT: _check_send_email,
