...
_KIND_TO_EFFECT: dict[str, EffectClass] = {
    ...
    "MEMORY_READ": EffectClass.FETCH,
    "MEMORY_CREATE": EffectClass.MUTATE_LOCAL,
    "MEMORY_WRITE": EffectClass.MUTATE_LOCAL,
    "MEMORY_MODIFY": EffectClass.MUTATE_LOCAL,
    "MEMORY_DELETE": EffectClass.DESTROY,
    ...
    "BROWSER_READ": EffectClass.FETCH,
    "BROWSER_NAVIGATE": EffectClass.EXECUTE_REMOTE,
    "BROWSER_INTERACT": EffectClass.EXECUTE_REMOTE,
    "BROWSER_SCRIPT": EffectClass.EXECUTE_REMOTE,
    "BROWSER_FILE": EffectClass.EXECUTE_REMOTE,
    "MACOS_APP_CONTROL": EffectClass.EXECUTE_HOST,
    "MACOS_CLIPBOARD_READ": EffectClass.FETCH,
    "MACOS_CLIPBOARD_WRITE": EffectClass.MUTATE_LOCAL,
    "MACOS_NOTIFICATION": EffectClass.EXECUTE_HOST,
    "APPLE_MAIL_READ": EffectClass.FETCH,
    "APPLE_MAIL_DRAFT": EffectClass.MUTATE_LOCAL,
    "KEYNOTE_READ": EffectClass.FETCH,
    "KEYNOTE_PRESENT": EffectClass.EXECUTE_HOST,
    "PAGES_READ": EffectClass.FETCH,
    "PAGES_EDIT": EffectClass.MUTATE_LOCAL,
    "PAGES_EXPORT": EffectClass.MUTATE_LOCAL,
    "NUMBERS_READ": EffectClass.FETCH,
    "NUMBERS_EDIT": EffectClass.MUTATE_LOCAL,
    "NUMBERS_EXPORT": EffectClass.MUTATE_LOCAL,
    "OUTLOOK_READ": EffectClass.FETCH,
    "OUTLOOK_DRAFT": EffectClass.MUTATE_LOCAL,
    "WORD_READ": EffectClass.FETCH,
    "WORD_EDIT": EffectClass.MUTATE_LOCAL,
    "WORD_EXPORT": EffectClass.MUTATE_LOCAL,
    "POWERPOINT_READ": EffectClass.FETCH,
    "POWERPOINT_EDIT": EffectClass.MUTATE_LOCAL,
    "POWERPOINT_EXPORT": EffectClass.MUTATE_LOCAL,
    "POWERPOINT_PRESENT": EffectClass.EXECUTE_HOST,
